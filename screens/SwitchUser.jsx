            ...
            <View className="flex-1 px-6 pt-20">
                <View className="mb-12">
                    ...
                    <Text className="text-base text-gray-500">
                        Enter your details to switch user to your account
                    </Text>
                </View>
                ...
                <Pressable
                    ...
                    disabled={loading}
                >
                    <Text className={`text-white font-semibold text-center text-lg ${loading ? "opacity-50" : ""}`}>{loading ? "Loading..." : "Switch User"}</Text>
                </Pressable>
            </View>
        </View>
    )
